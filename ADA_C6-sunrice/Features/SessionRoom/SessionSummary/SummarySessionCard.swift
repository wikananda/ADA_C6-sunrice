...
//    @ObservedObject var ideaManager: IdeaManager     // ObservableObject ✅ :contentReference[oaicite:0]{index=0}
//    let roundManager: RoundManager                   // Plain reference (not ObservableObject) :contentReference[oaicite:1]{index=1}
//    let sessionId: Int64
//    
...
//                sessionId: sessionId,
//                typeId: roundManager.getGreenTypeId() // only green ideas
//            )
...
//// MARK: - Preview
//
///// Preview that recreates the summary-ui layout
///// and calls `IdeaSummaryCard` exactly 3 times.
///// This preview is *not* using real backend data.
//struct SummarySe_Previews: PreviewProvider {
...
//                        commentCounts: CommentCounts(yellow: 0, black: 0, darkGreen: 0) // Neutral
//                    )
//                    IdeaSummaryCard(
//                        ideaText: "Guidebook on who's who and their expertise and how they can help",
//                        commentCounts: CommentCounts(yellow: 1, black: 3, darkGreen: 0) // Risky
//                    )
//                    IdeaSummaryCard(
//                        ideaText: "Make some material that they could read to at least prepare a bit on how to get into CBL process",
//                        commentCounts: CommentCounts(yellow: 4, black: 1, darkGreen: 0) // Good
//                    )
//                }
//            }
//            .padding(16)
